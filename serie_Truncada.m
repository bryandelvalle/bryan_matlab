...
%Podemos utilizar la serie de Fourier exponencial truncada como una aproximación a la función,
%f (t). Recordemos que siempre debemos utilizar un rango simétrico de n valores (-n0 ? n ? n0)
%para obtener una función real. Para n0 = 3:


%Tenga en cuenta que las 10 primeras líneas calculan los valores Fn como se muestra en una sección anterior.
%Esto es seguido por un bucle for que evalúa la suma en serie para cada valor de t. 
%Los valores se colocan en un vector fapprox. Las siguientes curvas resultan de este código de MATLAB:
