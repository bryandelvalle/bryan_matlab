...
%----------------------------------------------------------------------------------------------------------------------
%                        En este ejemplo, la frecuencia fundamental, f0 = 1 / T = 1/7. Por lo tanto, 
%                      el espectro de amplitud también se puede trazar frente a la frecuencia en Hz con
%                                             stem(n*(1/7),abs(Fn))
